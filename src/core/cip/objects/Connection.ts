...
export default class Connection {
  ...
  static BuildTransportClassTriggerCode(transport: ConnectionTransportClassTrigger) {
  ...
  static BuildNetworkConnectionParametersCode(options: NetworkConnectionParameters) {
    let code = 0;
