...
describe('Logical ClassID', () => {
  test('Padded Implicit 8-bit Format', () => {
    const segment = new Logical(Logical.Types.ClassID, 1);
  ...
  test('Padded Implicit 16-bit Format', () => {
    const segment = new Logical(Logical.Types.ClassID, 256);
    expect(segment.type.code).toBe(Logical.Types.ClassID);
  ...
  test('Padded Explicit 8-bit Format', () => {
    const segment = new Logical(Logical.Types.ClassID, 1, Logical.Formats.Address8Bit);
    expect(segment.type.code).toBe(Logical.Types.ClassID);
    expect(segment.format.code).toBe(Logical.Formats.Address8Bit);
    expect(segment.encode(true)).toEqual(Buffer.from([0x20, 0x01]));
  });
  ...
  test('Padded Explicit 16-bit Format', () => {
    const segment = new Logical(Logical.Types.ClassID, 256, Logical.Formats.Address16Bit);
    expect(segment.type.code).toBe(Logical.Types.ClassID);
    expect(segment.format.code).toBe(Logical.Formats.Address16Bit);
    expect(segment.encode(true)).toEqual(Buffer.from([0x21, 0x00, 0x00, 0x01]));
  });
  ...
  test('Padded Explicit 16-bit Format With 8-bit Value', () => {
    const segment = new Logical(Logical.Types.ClassID, 1, Logical.Formats.Address16Bit);
    expect(segment.type.code).toBe(Logical.Types.ClassID);
    expect(segment.format.code).toBe(Logical.Formats.Address16Bit);
  ...
  test('Invalid Explicit 32-bit Format With 8-bit Value', () => {
    expect(() => new Logical(Logical.Types.ClassID, 1, Logical.Formats.Address32Bit)).toThrow();
  });
  test('Invalid Explicit 32-bit Format', () => {
    expect(() => new Logical(Logical.Types.ClassID, 256, Logical.Formats.Address32Bit)).toThrow();
  });
});

describe('Logical InstanceID', () => {
  test('Padded Implicit 8-bit Format', () => {
    const segment = new Logical(Logical.Types.InstanceID, 1);
  ...
  test('Padded Implicit 16-bit Format', () => {
    const segment = new Logical(Logical.Types.InstanceID, 256);
    expect(segment.type.code).toBe(Logical.Types.InstanceID);
    expect(segment.format.code).toBe(Logical.Formats.Address16Bit);
  ...
  test('Padded Implicit 32-bit Format', () => {
    const segment = new Logical(Logical.Types.InstanceID, 0x10000);
    expect(segment.type.code).toBe(Logical.Types.InstanceID);
  ...
  test('Padded Explicit 8-bit Format', () => {
    const segment = new Logical(Logical.Types.InstanceID, 1, Logical.Formats.Address8Bit);
    expect(segment.type.code).toBe(Logical.Types.InstanceID);
    expect(segment.format.code).toBe(Logical.Formats.Address8Bit);
    expect(segment.encode(true)).toEqual(Buffer.from([0x24, 0x01]));
  });
  ...
  test('Padded Explicit 16-bit Format', () => {
    const segment = new Logical(Logical.Types.InstanceID, 256, Logical.Formats.Address16Bit);
    expect(segment.type.code).toBe(Logical.Types.InstanceID);
    expect(segment.format.code).toBe(Logical.Formats.Address16Bit);
    expect(segment.encode(true)).toEqual(Buffer.from([0x25, 0x00, 0x00, 0x01]));
  });
  ...
  test('Padded Explicit 32-bit Format', () => {
    const segment = new Logical(Logical.Types.InstanceID, 0x10000, Logical.Formats.Address32Bit);
    expect(segment.type.code).toBe(Logical.Types.InstanceID);
    expect(segment.format.code).toBe(Logical.Formats.Address32Bit);
    expect(segment.encode(true)).toEqual(Buffer.from([0x26, 0x00, 0x00, 0x00, 0x01, 0x00]));
  });
  ...
  test('Padded Explicit 16-bit Format With 8-bit Value', () => {
    const segment = new Logical(Logical.Types.InstanceID, 1, Logical.Formats.Address16Bit);
    expect(segment.type.code).toBe(Logical.Types.InstanceID);
    expect(segment.format.code).toBe(Logical.Formats.Address16Bit);
  ...
  test('Padded Explicit 32-bit Format With 8-bit Value', () => {
    const segment = new Logical(Logical.Types.InstanceID, 1, Logical.Formats.Address32Bit);
    expect(segment.type.code).toBe(Logical.Types.InstanceID);
    expect(segment.format.code).toBe(Logical.Formats.Address32Bit);
...
describe('Logical AttributeID', () => {
  test('Padded Implicit 8-bit Format', () => {
    const segment = new Logical(Logical.Types.AttributeID, 1);
  ...
  test('Padded Implicit 16-bit Format', () => {
    const segment = new Logical(Logical.Types.AttributeID, 256);
    expect(segment.type.code).toBe(Logical.Types.AttributeID);
    expect(segment.format.code).toBe(Logical.Formats.Address16Bit);
  ...
  test('Padded Explicit 8-bit Format', () => {
    const segment = new Logical(Logical.Types.AttributeID, 1, Logical.Formats.Address8Bit);
    expect(segment.type.code).toBe(Logical.Types.AttributeID);
    expect(segment.format.code).toBe(Logical.Formats.Address8Bit);
    expect(segment.encode(true)).toEqual(Buffer.from([0x30, 0x01]));
  });
  ...
  test('Padded Explicit 16-bit Format', () => {
    const segment = new Logical(Logical.Types.AttributeID, 256, Logical.Formats.Address16Bit);
    expect(segment.type.code).toBe(Logical.Types.AttributeID);
    expect(segment.format.code).toBe(Logical.Formats.Address16Bit);
    expect(segment.encode(true)).toEqual(Buffer.from([0x31, 0x00, 0x00, 0x01]));
  });
  ...
  test('Padded Explicit 16-bit Format With 8-bit Value', () => {
    const segment = new Logical(Logical.Types.AttributeID, 1, Logical.Formats.Address16Bit);
    expect(segment.type.code).toBe(Logical.Types.AttributeID);
    expect(segment.format.code).toBe(Logical.Formats.Address16Bit);
  ...
  test('Invalid Explicit 32-bit Format With 8-bit Value', () => {
    expect(() => new Logical(Logical.Types.AttributeID, 1, Logical.Formats.Address32Bit)).toThrow();
  });
  test('Invalid Explicit 32-bit Format With 16-bit Value', () => {
    expect(
      () => new Logical(Logical.Types.AttributeID, 256, Logical.Formats.Address32Bit),
    ).toThrow();
  });
});
