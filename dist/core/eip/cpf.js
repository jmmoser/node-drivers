...
export var ItemTypeIDs;
(function (ItemTypeIDs) {
    ItemTypeIDs[ItemTypeIDs["NullAddress"] = 0] = "NullAddress";
    ItemTypeIDs[ItemTypeIDs["ListIdentity"] = 12] = "ListIdentity";
    ItemTypeIDs[ItemTypeIDs["ConnectedAddress"] = 161] = "ConnectedAddress";
    ItemTypeIDs[ItemTypeIDs["ConnectedMessage"] = 177] = "ConnectedMessage";
    ItemTypeIDs[ItemTypeIDs["UnconnectedMessage"] = 178] = "UnconnectedMessage";
    ItemTypeIDs[ItemTypeIDs["ListServices"] = 256] = "ListServices";
    ItemTypeIDs[ItemTypeIDs["SockaddrInfoOtoT"] = 32768] = "SockaddrInfoOtoT";
    ItemTypeIDs[ItemTypeIDs["SockaddrInfoTtoO"] = 32769] = "SockaddrInfoTtoO";
    ItemTypeIDs[ItemTypeIDs["SequencedAddress"] = 32770] = "SequencedAddress";
...
export default class CPF {
    ...
    static DecodeListIdentityValue(buffer, offsetRef, dataLength) {
        ...
        offsetRef.current += 8;
        const attributes = CIPIdentity.DecodeInstanceAttributesAll(buffer, offsetRef, 1);
        attributes.push(CIPIdentity.DecodeAttribute(buffer, offsetRef, CIPIdentity.InstanceAttribute.State, 1));
        return {
