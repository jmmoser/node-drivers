 ...
 */
import { getBits, unsignedIntegerSize, } from '../../../../utils';
var ExtendedStringFormatCodes;
(function (ExtendedStringFormatCodes) {
    ExtendedStringFormatCodes[ExtendedStringFormatCodes["DoubleByteCharacters"] = 1] = "DoubleByteCharacters";
    ExtendedStringFormatCodes[ExtendedStringFormatCodes["TripleByteCharacters"] = 2] = "TripleByteCharacters";
    ExtendedStringFormatCodes[ExtendedStringFormatCodes["Numeric"] = 6] = "Numeric";
})(ExtendedStringFormatCodes || (ExtendedStringFormatCodes = {}));
;
var ExtendedStringNumericTypeCodes;
(function (ExtendedStringNumericTypeCodes) {
    ExtendedStringNumericTypeCodes[ExtendedStringNumericTypeCodes["USINT"] = 6] = "USINT";
    ExtendedStringNumericTypeCodes[ExtendedStringNumericTypeCodes["UINT"] = 7] = "UINT";
    ExtendedStringNumericTypeCodes[ExtendedStringNumericTypeCodes["UDINT"] = 8] = "UDINT";
})(ExtendedStringNumericTypeCodes || (ExtendedStringNumericTypeCodes = {}));
;
...
class SymbolicSegment {
    ...
    static Decode(buffer, offsetRef, segmentCode /* , padded */) {
        ...
        if (size === 0) {
            const extendedFormatCode = buffer.readUInt8(offsetRef.current);
            offsetRef.current += 1;
