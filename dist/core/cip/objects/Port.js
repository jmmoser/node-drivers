...
const ClassAttribute = Object.freeze({
    ...
    InstanceInfo: new CIPAttribute(ClassCodes.Port, 9, 'Instance Info', DataType.ABBREV_ARRAY(DataType.TRANSFORM(DataType.STRUCT([
        DataType.UINT,
...
const InstanceAttribute = Object.freeze({
    Type: new CIPAttribute(ClassCodes.Port, 1, 'Type', DataType.TRANSFORM(DataType.UINT, (value) => ({
        code: value,
        name: PortTypeNames[value] || 'Unknown',
    }))),
    Number: new CIPAttribute(ClassCodes.Port, 2, 'Number', DataType.UINT),
    Link: new CIPAttribute(ClassCodes.Port, 3, 'Link', DataType.TRANSFORM(DataType.STRUCT([
        DataType.UINT,
