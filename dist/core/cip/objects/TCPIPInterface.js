...
const IPAddressDataType = DataType.TRANSFORM(DataType.UDINT, (value) => `${value >>> 24}.${(value >>> 16) & 255}.${(value >>> 8) & 255}.${value & 255}`, (value) => {
...
const InstanceAttribute = Object.freeze({
    /** CIP Vol 2, 5-3.2.2.1 */
    Status: new CIPAttribute(ClassCodes.TCPIPInterface, 1, 'Status', DataType.TRANSFORM(DataType.DWORD, (value) => {
    ...
    /** CIP Vol 2, 5-3.2.2.2 */
    ConfigurationCapability: new CIPAttribute(ClassCodes.TCPIPInterface, 2, 'Configuration Capability', DataType.TRANSFORM(DataType.DWORD, (value) => {
    ...
    /** CIP Vol 2, 5-3.2.2.3 */
    ConfigurationControl: new CIPAttribute(ClassCodes.TCPIPInterface, 3, 'Configuration Control', DataType.TRANSFORM(DataType.DWORD, (value) => {
    ...
    PhysicalLinkObject: new CIPAttribute(ClassCodes.TCPIPInterface, 4, 'Physical Link Object', DataType.TRANSFORM(DataType.STRUCT([
        DataType.UINT,
