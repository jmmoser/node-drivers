...
const InstanceAttribute = Object.freeze({
    InterfaceSpeed: new CIPAttribute(ClassCodes.EthernetLink, 1, 'Interface Speed', DataType.TRANSFORM(DataType.UDINT, (value) => `${value} Mbps`)),
    /**
     * Bit 0 - Link Status
    ...
    InterfaceFlags: new CIPAttribute(ClassCodes.EthernetLink, 2, 'Interface Flags', DataType.TRANSFORM(DataType.DWORD, (value) => {
    ...
    PhysicalAddress: new CIPAttribute(ClassCodes.EthernetLink, 3, 'Physical Address', DataType.TRANSFORM(DataType.ABBREV_ARRAY(DataType.USINT, 6), (value) => value.map((v) => v.toString(16).padStart(2, '0')).join(':'))),
    InterfaceCounters: new CIPAttribute(ClassCodes.EthernetLink, 4, 'Interface Counters', DataType.TRANSFORM(DataType.STRUCT([
        DataType.UDINT,
        DataType.UDINT,
        DataType.UDINT,
        DataType.UDINT,
    ...
    MediaCounters: new CIPAttribute(ClassCodes.EthernetLink, 5, 'Media Counters', DataType.TRANSFORM(DataType.STRUCT([
        DataType.UDINT,
        DataType.UDINT,
        DataType.UDINT,
        DataType.UDINT,
    ...
    InterfaceControl: new CIPAttribute(ClassCodes.EthernetLink, 6, 'Interface Control', DataType.TRANSFORM(DataType.STRUCT([
        /**
         * Control Bits
