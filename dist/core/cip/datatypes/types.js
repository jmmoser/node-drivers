    ...
    STRINGI() {
        ...
        return {
            ...
            itype: DataType.STRUCT([
                DataType.USINT,
                DataType.PLACEHOLDER((length) => DataType.ARRAY(DataType.STRUCT([
                    DataType.TRANSFORM(
                    /* First three characters of the ISO 639-2/T language */
                    DataType.ARRAY(DataType.USINT, 0, 2), (val) => Buffer.from(val).toString('ascii'), (val) => Buffer.from(val, 'ascii')),
